  ...
  const userTypes = [
    {
      ...
      description: "Get guidance on college selection, course recommendations, and career planning based on your interests and academic performance.",
      features: ["College Recommendations", "Course Selection", "Career Mapping", "Scholarship Info"]
    },
    {
      icon: "🎓",
      title: "College Students",
      description: "Access internship opportunities, skill development programs, and industry insights to boost your career prospects.",
      features: ["Internship Portal", "Skill Assessment", "Industry Connect", "Project Guidance"]
    },
    {
      icon: "👨‍💻",
      title: "Freshers",
      description: "Land your dream job with interview preparation, resume optimization, and personalized job recommendations.",
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-muted/30 to-background overflow-hidden">
        ...
        >
          <Badge className="mb-8 bg-gradient-to-r from-primary/10 to-secondary/10 text-primary border-primary/20 hover-lift">
