...
const Contact = () => {
  ...
  const faqs = [
    {
      question: "How do I get started with CareerGuide?",
      answer: "Simply register on our platform by selecting your user type (college joining student, college student, or fresher). You'll get personalized recommendations based on your profile."
    },
    {
      question: "Are the courses free?",
      answer: "We offer both free and paid courses. Many of our introductory courses are free, while advanced courses require enrollment fees. Check individual course details for pricing."
    },
    {
      question: "How does the resume builder work?",
      answer: "Our resume builder guides you through a step-by-step process to create a professional resume. Fill in your information across different sections and download as a PDF when complete."
    },
    {
      question: "Do you provide placement assistance?",
      answer: "Yes! We partner with leading companies to provide internship and job opportunities. College students and freshers can access our job portal for relevant openings."
    },
    {
      question: "Can I get personal career guidance?",
      answer: "Absolutely! We offer personalized career counseling sessions. Contact us to schedule a one-on-one session with our career experts."
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          ...
          >
            <Card className="content-section animate-slideInLeft">
              ...
              <CardContent className="space-y-4">
                {contactInfo.map((info, index) => (
                  <div key={index} className="flex items-start space-x-3 animate-bounce-in" style={{ animationDelay: `${index * 0.1}s` }}>
            ...
            {/* Quick Links */}
            <Card className="content-section animate-slideInLeft" style={{ animationDelay: '0.3s' }}>
              <CardHeader>
            ...
            <Card className="content-section animate-slideInRight">
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button type="submit" className="w-full hover-lift animate-fadeInUp" size="lg" style={{ animationDelay: '0.7s' }}>
                    <Send className="h-4 w-4 mr-2" />
                    Send Message
                  </Button>

                  <p className="text-sm text-muted-foreground text-center animate-fadeInUp" style={{ animationDelay: '0.8s' }}>
          ...
          <Card className="content-section animate-scaleIn">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {faqs.map((faq, index) => (
                  <div key={index} className="space-y-2 animate-bounce-in" style={{ animationDelay: `${index * 0.1}s` }}>
